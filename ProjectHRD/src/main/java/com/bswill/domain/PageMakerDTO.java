...
public class PageMakerDTO {
	...
	private int total;
	private BoardCri cri;
	
	public PageMakerDTO(BoardCri cri, int total) {
		this.cri = cri;
		this.total = total;
        ...
        /* 전체 마지막 페이지 */
        int realEnd = (int)(Math.ceil(total * 1.0/cri.getPageSize()));
	...
	public BoardCri getCri() {
		return cri;
	}

	public void setCri(BoardCri cri) {
		this.cri = cri;
	}
