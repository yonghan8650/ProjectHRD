	...
	<section class="content">
		<div class="col-md-3">
			...
			<div class="box box-primary">
				<div class="box-body box-profile">
					...
					<ul class="list-group list-group-unbordered">
						<li class="list-group-item"><b>창립일</b> <a class="pull-right">2020.03.27</a></li>
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<strong><i class="fa fa-flag margin-r-5"></i> &nbsp; 2020년 Bswill 설립</strong>
					...
					<hr>
					<strong><i class="fa fa-genderless margin-r-5"></i> &nbsp; 2023년 지속적인 혁신 및 성장 </strong>
